...
export const CONVERSION_DATA: CategoryDefinition[] = [
  ...
  },
  {
    ...
    units: [
      ...
      { id: "bottle_beer_small", name: "Bottle (Beer, small)", symbol: "btl", factor: 0.3, beerWine: true },
      { id: "bottle_beer_longneck", name: "Bottle (Beer, longneck)", symbol: "btl", factor: 0.354882, beerWine: true },
      { id: "bottle_beer_large", name: "Bottle (Beer, large)", symbol: "btl", factor: 0.5, beerWine: true },
