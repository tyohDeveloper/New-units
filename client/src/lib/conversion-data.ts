...
export const CONVERSION_DATA: CategoryDefinition[] = [
  ...
  },
  {
    ...
    units: [
      ...
      { id: "gald", name: "US Gallon/day", symbol: "gal⋅d⁻¹", factor: 0.003785412/86400 },
      { id: "lh", name: "Liter/hour", symbol: "L⋅h⁻¹", factor: 0.001/3600 },
      { id: "cm3s", name: "Cubic Centimetre/second", symbol: "cm³⋅s⁻¹", factor: 1e-6 },
      { id: "galh", name: "US Gallon/hour", symbol: "gal⋅h⁻¹", factor: 0.003785412/3600 },
      ...
      { id: "gpm", name: "US Gallon/minute", symbol: "GPM", factor: 0.003785412/60 },
