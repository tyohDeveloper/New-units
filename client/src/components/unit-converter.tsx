...
export default function UnitConverter() {
  ...
  const TRANSLATIONS: Record<string, { 
    ...
    'Barn': { en: 'Barn', ar: 'بارن', de: 'Barn', es: 'Barn', fr: 'Barn', it: 'Barn', pt: 'Barn', ru: 'Барн', zh: '靶恩', ja: 'バーン' },
    'Dunam': { en: 'Dunam', ar: 'دونم', de: 'Dunam', es: 'Dunam', fr: 'Dunam', it: 'Dunam', pt: 'Dunam', ru: 'Дунам', zh: '杜纳姆', ja: 'ドゥナム' },
    'Township (US)': { en: 'Township (US)', ar: 'بلدية (أمريكي)', de: 'Township (US)', es: 'Township (EE.UU.)', fr: 'Township (US)', it: 'Township (US)', pt: 'Township (EUA)', ru: 'Тауншип (США)', zh: '镇区（美国）', ja: 'タウンシップ（米国）' },
    'Section (US)': { en: 'Section (US)', ar: 'قسم (أمريكي)', de: 'Section (US)', es: 'Sección (EE.UU.)', fr: 'Section (US)', it: 'Sezione (US)', pt: 'Seção (EUA)', ru: 'Секция (США)', zh: '区（美国）', ja: 'セクション（米国）' },
    'Square Degree': { en: 'Square Degree', ar: 'درجة مربعة', de: 'Quadratgrad', es: 'Grado Cuadrado', fr: 'Degré Carré', it: 'Grado Quadrato', pt: 'Grau Quadrado', ru: 'Квадратный Градус', zh: '平方度', ja: '平方度' },
    'Cubic Meter': { en: 'Cubic Meter', ar: 'متر مكعب', de: 'Kubikmeter', es: 'Metro Cúbico', fr: 'Mètre Cube', it: 'Metro Cubo', pt: 'Metro Cúbico', ru: 'Кубический Метр', zh: '立方米', ja: '立方メートル' },
    'Cubic Metre': { en: 'Cubic Metre', ar: 'متر مكعب', de: 'Kubikmeter', es: 'Metro Cúbico', fr: 'Mètre Cube', it: 'Metro Cubo', pt: 'Metro Cúbico', ru: 'Кубический Метр', zh: '立方米', ja: '立方メートル' },
    'Liter': { 
    ...
    'Cubic Foot': { en: 'Cubic Foot', ar: 'قدم مكعب', de: 'Kubikfuß', es: 'Pie Cúbico', fr: 'Pied Cube', it: 'Piede Cubo', pt: 'Pé Cúbico', ru: 'Кубический Фут', zh: '立方英尺', ja: '立方フィート' },
    'Cubic Yard': { en: 'Cubic Yard', ar: 'ياردة مكعبة', de: 'Kubikyard', es: 'Yarda Cúbica', fr: 'Yard Cube', it: 'Iarda Cubica', pt: 'Jarda Cúbica', ru: 'Кубический Ярд', zh: '立方码', ja: '立方ヤード' },
    'Fluid Ounce (US)': { en: 'Fluid Ounce (US)', ar: 'أونصة سائلة (أمريكي)', de: 'Flüssigunze (US)', es: 'Onza Líquida (EE.UU.)', fr: 'Once Liquide (US)', it: 'Oncia Fluida (US)', pt: 'Onça Líquida (EUA)', ru: 'Жидкая Унция (США)', zh: '液量盎司（美国）', ja: '液量オンス（米国）' },
    'Fluid Ounce (Imp)': { en: 'Fluid Ounce (Imp)', ar: 'أونصة سائلة (إمبراطوري)', de: 'Flüssigunze (Imp)', es: 'Onza Líquida (Imp)', fr: 'Once Liquide (Imp)', it: 'Oncia Fluida (Imp)', pt: 'Onça Líquida (Imperial)', ru: 'Жидкая Унция (Имп)', zh: '液量盎司（英制）', ja: '液量オンス（英国）' },
    'Tablespoon (US)': { en: 'Tablespoon (US)', ar: 'ملعقة كبيرة (أمريكي)', de: 'Esslöffel (US)', es: 'Cucharada (EE.UU.)', fr: 'Cuillère à Soupe (US)', it: 'Cucchiaio (US)', pt: 'Colher de Sopa (EUA)', ru: 'Столовая Ложка (США)', zh: '汤匙（美国）', ja: '大さじ（米国）' },
    'Tablespoon (Imp)': { en: 'Tablespoon (Imp)', ar: 'ملعقة كبيرة (إمبراطوري)', de: 'Esslöffel (Imp)', es: 'Cucharada (Imp)', fr: 'Cuillère à Soupe (Imp)', it: 'Cucchiaio (Imp)', pt: 'Colher de Sopa (Imperial)', ru: 'Столовая Ложка (Имп)', zh: '汤匙（英制）', ja: '大さじ（英国）' },
    'Teaspoon (US)': { en: 'Teaspoon (US)', ar: 'ملعقة صغيرة (أمريكي)', de: 'Teelöffel (US)', es: 'Cucharadita (EE.UU.)', fr: 'Cuillère à Café (US)', it: 'Cucchiaino (US)', pt: 'Colher de Chá (EUA)', ru: 'Чайная Ложка (США)', zh: '茶匙（美国）', ja: '小さじ（米国）' },
    'Teaspoon (Imp)': { en: 'Teaspoon (Imp)', ar: 'ملعقة صغيرة (إمبراطوري)', de: 'Teelöffel (Imp)', es: 'Cucharadita (Imp)', fr: 'Cuillère à Café (Imp)', it: 'Cucchiaino (Imp)', pt: 'Colher de Chá (Imperial)', ru: 'Чайная Ложка (Имп)', zh: '茶匙（英制）', ja: '小さじ（英国）' },
    'Cup (US)': { en: 'Cup (US)', ar: 'كوب (أمريكي)', de: 'Tasse (US)', es: 'Taza (EE.UU.)', fr: 'Tasse (US)', it: 'Tazza (US)', pt: 'Xícara (EUA)', ru: 'Чашка (США)', zh: '杯（美国）', ja: 'カップ（米国）' },
    'Pint (US)': { en: 'Pint (US)', ar: 'باينت (أمريكي)', de: 'Pint (US)', es: 'Pinta (EE.UU.)', fr: 'Pinte (US)', it: 'Pinta (US)', pt: 'Pinto (EUA)', ru: 'Пинта (США)', zh: '品脱（美国）', ja: 'パイント（米国）' },
    'Pint (Imp)': { en: 'Pint (Imp)', ar: 'باينت (إمبراطوري)', de: 'Pint (Imp)', es: 'Pinta (Imp)', fr: 'Pinte (Imp)', it: 'Pinta (Imp)', pt: 'Pinto (Imperial)', ru: 'Пинта (Имп)', zh: '品脱（英制）', ja: 'パイント（英国）' },
    'Quart (US)': { en: 'Quart (US)', ar: 'كوارت (أمريكي)', de: 'Quart (US)', es: 'Cuarto (EE.UU.)', fr: 'Quart (US)', it: 'Quarto (US)', pt: 'Quarto (EUA)', ru: 'Кварта (США)', zh: '夸脱（美国）', ja: 'クォート（米国）' },
    'Quart (Imp)': { en: 'Quart (Imp)', ar: 'كوارت (إمبراطوري)', de: 'Quart (Imp)', es: 'Cuarto (Imp)', fr: 'Quart (Imp)', it: 'Quarto (Imp)', pt: 'Quarto (Imperial)', ru: 'Кварта (Имп)', zh: '夸脱（英制）', ja: 'クォート（英国）' },
    'Gallon (US)': { 
    ...
    'Barrel (Oil)': { en: 'Barrel (Oil)', ar: 'برميل (نفط)', de: 'Barrel (Öl)', es: 'Barril (Petróleo)', fr: 'Baril (Pétrole)', it: 'Barile (Petrolio)', pt: 'Barril (Petróleo)', ru: 'Баррель (Нефть)', zh: '桶（石油）', ja: 'バレル（石油）' },
    'Barrel (Beer)': { en: 'Barrel (Beer)', ar: 'برميل (بيرة)', de: 'Fass (Bier)', es: 'Barril (Cerveza)', fr: 'Tonneau (Bière)', it: 'Barile (Birra)', pt: 'Barril (Cerveja)', ru: 'Бочка (Пиво)', zh: '桶（啤酒）', ja: 'バレル（ビール）' },
    'Keg (Beer)': { en: 'Keg (Beer)', ar: 'برميل صغير (بيرة)', de: 'Fass (Bier)', es: 'Barrilete (Cerveza)', fr: 'Fût (Bière)', it: 'Fusto (Birra)', pt: 'Barril (Cerveja)', ru: 'Кег (Пиво)', zh: '小桶（啤酒）', ja: 'ケグ（ビール）' },
    'Mini Keg (Beer)': { en: 'Mini Keg (Beer)', ar: 'برميل صغير جداً (بيرة)', de: 'Mini-Fass (Bier)', es: 'Mini Barrilete (Cerveza)', fr: 'Mini Fût (Bière)', it: 'Mini Fusto (Birra)', pt: 'Mini Barril (Cerveja)', ru: 'Мини-кег (Пиво)', zh: '迷你桶（啤酒）', ja: 'ミニケグ（ビール）' },
    'Bottle (Wine)': { en: 'Bottle (Wine)', ar: 'زجاجة (نبيذ)', de: 'Flasche (Wein)', es: 'Botella (Vino)', fr: 'Bouteille (Vin)', it: 'Bottiglia (Vino)', pt: 'Garrafa (Vinho)', ru: 'Бутылка (Вино)', zh: '瓶（葡萄酒）', ja: 'ボトル（ワイン）' },
    'Magnum (Wine)': { en: 'Magnum (Wine)', ar: 'ماغنوم (نبيذ)', de: 'Magnum (Wein)', es: 'Magnum (Vino)', fr: 'Magnum (Vin)', it: 'Magnum (Vino)', pt: 'Magnum (Vinho)', ru: 'Магнум (Вино)', zh: '大瓶（葡萄酒）', ja: 'マグナム（ワイン）' },
    'Bottle (Beer, small)': { en: 'Bottle (Beer, small)', ar: 'زجاجة (بيرة، صغيرة)', de: 'Flasche (Bier, klein)', es: 'Botella (Cerveza, pequeña)', fr: 'Bouteille (Bière, petite)', it: 'Bottiglia (Birra, piccola)', pt: 'Garrafa (Cerveja, pequena)', ru: 'Бутылка (Пиво, маленькая)', zh: '瓶（啤酒，小）', ja: 'ボトル（ビール、小）' },
    'Bottle (Beer, longneck)': { en: 'Bottle (Beer, longneck)', ar: 'زجاجة (بيرة، طويلة)', de: 'Flasche (Bier, Longneck)', es: 'Botella (Cerveza, cuello largo)', fr: 'Bouteille (Bière, long col)', it: 'Bottiglia (Birra, collo lungo)', pt: 'Garrafa (Cerveja, long neck)', ru: 'Бутылка (Пиво, длинное горлышко)', zh: '瓶（啤酒，长颈）', ja: 'ボトル（ビール、ロングネック）' },
    'Bottle (Beer, large)': { en: 'Bottle (Beer, large)', ar: 'زجاجة (بيرة، كبيرة)', de: 'Flasche (Bier, groß)', es: 'Botella (Cerveza, grande)', fr: 'Bouteille (Bière, grande)', it: 'Bottiglia (Birra, grande)', pt: 'Garrafa (Cerveja, grande)', ru: 'Бутылка (Пиво, большая)', zh: '瓶（啤酒，大）', ja: 'ボトル（ビール、大）' },
    'Bushel': { en: 'Bushel', ar: 'بوشل', de: 'Scheffel', es: 'Bushel', fr: 'Boisseau', it: 'Bushel', pt: 'Alqueire', ru: 'Бушель', zh: '蒲式耳', ja: 'ブッシェル' },
    'Acre-foot': { en: 'Acre-foot', ar: 'فدان قدم', de: 'Acre-Fuß', es: 'Acre-pie', fr: 'Acre-pied', it: 'Acro-piede', pt: 'Acre-pé', ru: 'Акр-фут', zh: '英亩英尺', ja: 'エーカーフィート' },
    'Cubic Mile': { en: 'Cubic Mile', ar: 'ميل مكعب', de: 'Kubikmeile', es: 'Milla Cúbica', fr: 'Mille Cube', it: 'Miglio Cubo', pt: 'Milha Cúbica', ru: 'Кубическая Миля', zh: '立方英里', ja: '立方マイル' },
    'Hertz': { en: 'Hertz', ar: 'هرتز', de: 'Hertz', es: 'Hercio', fr: 'Hertz', it: 'Hertz', pt: 'Hertz', ru: 'Герц', zh: '赫兹', ja: 'ヘルツ' },
    'Meter/Second': { en: 'Meter/Second', ar: 'متر/ثانية', de: 'Meter/Sekunde', es: 'Metro/Segundo', fr: 'Mètre/Seconde', it: 'Metro/Secondo', pt: 'Metro/Segundo', ru: 'Метр/Секунда', zh: '米/秒', ja: 'メートル/秒' },
    'Meter/sq sec': { en: 'Meter/sq sec', ar: 'متر/ثانية²', de: 'Meter/Sek²', es: 'Metro/seg²', fr: 'Mètre/sec²', it: 'Metro/sec²', pt: 'Metro/seg²', ru: 'Метр/сек²', zh: '米/秒²', ja: 'メートル/秒²' },
    'Kilometer/Hour': { en: 'Kilometer/Hour', ar: 'كيلومتر/ساعة', de: 'Kilometer/Stunde', es: 'Kilómetro/Hora', fr: 'Kilomètre/Heure', it: 'Chilometro/Ora', pt: 'Quilômetro/Hora', ru: 'Километр/Час', zh: '千米/小时', ja: 'キロメートル/時' },
    'Mile/Hour': { en: 'Mile/Hour', ar: 'ميل/ساعة', de: 'Meile/Stunde', es: 'Milla/Hora', fr: 'Mille/Heure', it: 'Miglio/Ora', pt: 'Milha/Hora', ru: 'Миля/Час', zh: '英里/小时', ja: 'マイル/時' },
    'Knot': { en: 'Knot', ar: 'عقدة', de: 'Knoten', es: 'Nudo', fr: 'Nœud', it: 'Nodo', pt: 'Nó', ru: 'Узел', zh: '节', ja: 'ノット' },
    'Speed of Light': { en: 'Speed of Light', ar: 'سرعة الضوء', de: 'Lichtgeschwindigkeit', es: 'Velocidad de la Luz', fr: 'Vitesse de la Lumière', it: 'Velocità della Luce', pt: 'Velocidade da Luz', ru: 'Скорость Света', zh: '光速', ja: '光速' },
    'Mach': { en: 'Mach', ar: 'ماخ', de: 'Mach', es: 'Mach', fr: 'Mach', it: 'Mach', pt: 'Mach', ru: 'Мах', zh: '马赫', ja: 'マッハ' },
    'Foot/sq sec': { en: 'Foot/sq sec', ar: 'قدم/ثانية²', de: 'Fuß/Sek²', es: 'Pie/seg²', fr: 'Pied/sec²', it: 'Piede/sec²', pt: 'Pé/seg²', ru: 'Фут/сек²', zh: '英尺/秒²', ja: 'フィート/秒²' },
    'Gal': { en: 'Gal', ar: 'غال', de: 'Gal', es: 'Gal', fr: 'Gal', it: 'Gal', pt: 'Gal', ru: 'Гал', zh: '伽', ja: 'ガル' },
    'g-force': { en: 'g-force', ar: 'قوة جاذبية', de: 'g-Kraft', es: 'Fuerza g', fr: 'Force g', it: 'Forza g', pt: 'Força g', ru: 'Сила g', zh: 'g力', ja: 'G力' },
    'Newton': { en: 'Newton', ar: 'نيوتن', de: 'Newton', es: 'Newton', fr: 'Newton', it: 'Newton', pt: 'Newton', ru: 'Ньютон', zh: '牛顿', ja: 'ニュートン' },
    'Dyne': { en: 'Dyne', ar: 'داين', de: 'Dyn', es: 'Dina', fr: 'Dyne', it: 'Dina', pt: 'Dina', ru: 'Дина', zh: '达因', ja: 'ダイン' },
    'Kilogram-force': { en: 'Kilogram-force', ar: 'كيلوغرام قوة', de: 'Kilopond', es: 'Kilogramo-fuerza', fr: 'Kilogramme-force', it: 'Chilogrammo-forza', pt: 'Quilograma-força', ru: 'Килограмм-сила', zh: '千克力', ja: 'キログラム重' },
    'Pound-force': { en: 'Pound-force', ar: 'باوند قوة', de: 'Pound-force', es: 'Libra-fuerza', fr: 'Livre-force', it: 'Libbra-forza', pt: 'Libra-força', ru: 'Фунт-сила', zh: '磅力', ja: 'ポンド重' },
    'Poundal': { en: 'Poundal', ar: 'باوندال', de: 'Poundal', es: 'Poundal', fr: 'Poundal', it: 'Poundal', pt: 'Poundal', ru: 'Паундаль', zh: '磅达', ja: 'パウンダル' },
    'Kip': { en: 'Kip', ar: 'كيب', de: 'Kip', es: 'Kip', fr: 'Kip', it: 'Kip', pt: 'Kip', ru: 'Кип', zh: '千磅力', ja: 'キップ' },
    'Pascal': { en: 'Pascal', ar: 'باسكال', de: 'Pascal', es: 'Pascal', fr: 'Pascal', it: 'Pascal', pt: 'Pascal', ru: 'Паскаль', zh: '帕斯卡', ja: 'パスカル' },
    'Bar': { en: 'Bar', ar: 'بار', de: 'Bar', es: 'Bar', fr: 'Bar', it: 'Bar', pt: 'Bar', ru: 'Бар', zh: '巴', ja: 'バール' },
    'Millibar': { en: 'Millibar', ar: 'ميليبار', de: 'Millibar', es: 'Milibar', fr: 'Millibar', it: 'Millibar', pt: 'Milibar', ru: 'Миллибар', zh: '毫巴', ja: 'ミリバール' },
    'Microbar': { en: 'Microbar', ar: 'ميكروبار', de: 'Mikrobar', es: 'Microbar', fr: 'Microbar', it: 'Microbar', pt: 'Microbar', ru: 'Микробар', zh: '微巴', ja: 'マイクロバール' },
    'Atmosphere': { en: 'Atmosphere', ar: 'ضغط جوي', de: 'Atmosphäre', es: 'Atmósfera', fr: 'Atmosphère', it: 'Atmosfera', pt: 'Atmosfera', ru: 'Атмосфера', zh: '大气压', ja: '気圧' },
    'PSI': { en: 'PSI', ar: 'باوند/بوصة²', de: 'PSI', es: 'PSI', fr: 'PSI', it: 'PSI', pt: 'PSI', ru: 'PSI', zh: '磅/平方英寸', ja: 'PSI' },
    'Torr': { en: 'Torr', ar: 'تور', de: 'Torr', es: 'Torr', fr: 'Torr', it: 'Torr', pt: 'Torr', ru: 'Торр', zh: '托', ja: 'トル' },
    'mmHg': { en: 'mmHg', ar: 'ملم زئبق', de: 'mmHg', es: 'mmHg', fr: 'mmHg', it: 'mmHg', pt: 'mmHg', ru: 'мм рт. ст.', zh: '毫米汞柱', ja: 'mmHg' },
    'Dyne/cm²': { en: 'Dyne/cm²', ar: 'داين/سم²', de: 'Dyn/cm²', es: 'Dina/cm²', fr: 'Dyne/cm²', it: 'Dina/cm²', pt: 'Dina/cm²', ru: 'Дин/см²', zh: '达因/cm²', ja: 'ダイン/cm²' },
    'Joule': { en: 'Joule', ar: 'جول', de: 'Joule', es: 'Julio', fr: 'Joule', it: 'Joule', pt: 'Joule', ru: 'Джоуль', zh: '焦耳', ja: 'ジュール' },
    'Kilojoule': { en: 'Kilojoule', ar: 'كيلوجول', de: 'Kilojoule', es: 'Kilojulio', fr: 'Kilojoule', it: 'Kilojoule', pt: 'Quilojoule', ru: 'Килоджоуль', zh: '千焦', ja: 'キロジュール' },
    'Calorie': { en: 'Calorie', ar: 'سعرة', de: 'Kalorie', es: 'Caloría', fr: 'Calorie', it: 'Caloria', pt: 'Caloria', ru: 'Калория', zh: '卡路里', ja: 'カロリー' },
    'Kilocalorie': { en: 'Kilocalorie', ar: 'كيلوسعرة', de: 'Kilokalorie', es: 'Kilocaloría', fr: 'Kilocalorie', it: 'Chilocaloria', pt: 'Quilocaloria', ru: 'Килокалория', zh: '千卡', ja: 'キロカロリー' },
    'BTU': { en: 'BTU', ar: 'وحدة حرارية بريطانية', de: 'BTU', es: 'BTU', fr: 'BTU', it: 'BTU', pt: 'BTU', ru: 'БТЕ', zh: '英热单位', ja: 'BTU' },
    'Watt-hour': { en: 'Watt-hour', ar: 'واط ساعة', de: 'Wattstunde', es: 'Vatio-hora', fr: 'Watt-heure', it: 'Wattora', pt: 'Watt-hora', ru: 'Ватт-час', zh: '瓦时', ja: 'ワット時' },
    'Kilowatt-hour': { en: 'Kilowatt-hour', ar: 'كيلوواط ساعة', de: 'Kilowattstunde', es: 'Kilovatio-hora', fr: 'Kilowatt-heure', it: 'Chilowattora', pt: 'Quilowatt-hora', ru: 'Киловатт-час', zh: '千瓦时', ja: 'キロワット時' },
    'Electronvolt': { en: 'Electronvolt', ar: 'إلكترون فولت', de: 'Elektronenvolt', es: 'Electronvoltio', fr: 'Électronvolt', it: 'Elettronvolt', pt: 'Elétron-volt', ru: 'Электронвольт', zh: '电子伏特', ja: '電子ボルト' },
    'Erg': { en: 'Erg', ar: 'إرغ', de: 'Erg', es: 'Ergio', fr: 'Erg', it: 'Erg', pt: 'Erg', ru: 'Эрг', zh: '尔格', ja: 'エルグ' },
    'Foot-pound': { en: 'Foot-pound', ar: 'قدم باوند', de: 'Fußpfund', es: 'Pie-libra', fr: 'Pied-livre', it: 'Piede-libbra', pt: 'Pé-libra', ru: 'Фут-фунт', zh: '英尺磅', ja: 'フィートポンド' },
    'Ton of TNT': { en: 'Ton of TNT', ar: 'طن TNT', de: 'Tonne TNT', es: 'Tonelada de TNT', fr: 'Tonne de TNT', it: 'Tonnellata di TNT', pt: 'Tonelada de TNT', ru: 'Тонна ТНТ', zh: '吨TNT', ja: 'トンTNT' },
    'Watt': { en: 'Watt', ar: 'واط', de: 'Watt', es: 'Vatio', fr: 'Watt', it: 'Watt', pt: 'Watt', ru: 'Ватт', zh: '瓦特', ja: 'ワット' },
    'Kilowatt': { en: 'Kilowatt', ar: 'كيلوواط', de: 'Kilowatt', es: 'Kilovatio', fr: 'Kilowatt', it: 'Chilowatt', pt: 'Quilowatt', ru: 'Киловатт', zh: '千瓦', ja: 'キロワット' },
    'Horsepower': { en: 'Horsepower', ar: 'حصان', de: 'Pferdestärke', es: 'Caballo de Fuerza', fr: 'Cheval-vapeur', it: 'Cavallo Vapore', pt: 'Cavalo-vapor', ru: 'Лошадиная Сила', zh: '马力', ja: '馬力' },
    'Metric HP': { en: 'Metric HP', ar: 'حصان متري', de: 'Metrische PS', es: 'CV Métrico', fr: 'CV Métrique', it: 'CV Metrico', pt: 'CV Métrico', ru: 'Метрическая Л.С.', zh: '公制马力', ja: '仏馬力' },
    'Ton Refrigeration': { en: 'Ton Refrigeration', ar: 'طن تبريد', de: 'Kältetonne', es: 'Tonelada de Refrigeración', fr: 'Tonne de Réfrigération', it: 'Tonnellata di Refrigerazione', pt: 'Tonelada de Refrigeração', ru: 'Тонна Охлаждения', zh: '冷吨', ja: '冷凍トン' },
    'Coulomb': { en: 'Coulomb', ar: 'كولوم' },
          ...
          <div className="grid gap-8 relative z-10">
            ...
            <div className="grid gap-4">
              <div className="flex items-center gap-2">
                <div className="flex items-center justify-between flex-1" style={{ minWidth: '220px' }}>
