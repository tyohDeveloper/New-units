...
export default function UnitConverter() {
  ...
  const TRANSLATIONS: Record<string, { en: string; ar: string }> = {
    ...
    'Flow Rate (Volumetric)': { en: 'Flow Rate (Volumetric)', ar: 'معدل التدفق (الحجمي)' },
    'Density': { en: 'Density', ar: 'الكثافة' },
    'Dynamic Viscosity': { en: 'Dynamic Viscosity', ar: 'اللزوجة الديناميكية' },
    'Viscosity (Dynamic)': { en: 'Viscosity (Dynamic)', ar: 'اللزوجة (الديناميكية)' },
    'Surface Tension': { en: 'Surface Tension', ar: 'التوتر السطحي' },
    'Charge': { en: 'Charge', ar: 'الشحنة' },
    'Electric Charge': { en: 'Electric Charge', ar: 'الشحنة الكهربائية' },
    'Potential': { en: 'Potential', ar: 'الجهد' },
    'Electric Potential': { en: 'Electric Potential', ar: 'الجهد الكهربائي' },
    ...
    'Absorbed Radiation Dose': { en: 'Absorbed Radiation Dose', ar: 'جرعة الإشعاع الممتص' },
    'Equivalent Dose': { en: 'Equivalent Dose', ar: 'الجرعة المكافئة' },
    'Equivalent Radiation Dose': { en: 'Equivalent Radiation Dose', ar: 'جرعة الإشعاع المكافئة' },
    'Catalytic Activity': { en: 'Catalytic Activity', ar: 'النشاط التحفيزي' },
    'Angle': { en: 'Angle', ar: 'الزاوية' },
    'Plane Angle': { en: 'Plane Angle', ar: 'الزاوية المستوية' },
    ...
    'Luminous Flux (Human)': { en: 'Luminous Flux (Human)', ar: 'التدفق الضوئي (البشري)' },
    ...
    'Refractive Power (Vision)': { en: 'Refractive Power (Vision)', ar: 'قوة الانكسار (البصر)' },
